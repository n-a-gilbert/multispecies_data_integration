# 15 March 2023
# Neil Gilbert
# This script runs simulations for an single-species, distance-sampling only model for a rare species
...
save(outs, sp_info, alpha1_diff, N_RB_DS, file = paste0("simulation_comparison_ssds_rare_", Sys.Date(), ".RData"))