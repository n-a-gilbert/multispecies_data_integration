# 15 March 2023
# Neil Gilbert
# This script runs simulations for a hierarchical community model for count data only
...
save(outs, sp_info, alpha1_diff, N_RB_TC, file = paste0("simulation_comparison_cc_", Sys.Date(), ".RData"))