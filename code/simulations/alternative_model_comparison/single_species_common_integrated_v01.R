# 15 March 2023
# Neil Gilbert
# This script runs simulations for an integrated single-species model for a common species
...
save(outs, sp_info, alpha1_diff, N_RB_TC, N_RB_DS, file = paste0("simulation_comparison_iss_common_", Sys.Date(), ".RData"))