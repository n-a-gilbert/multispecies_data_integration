# 15 March 2023
# Neil Gilbert
# This script runs simulations for an single-species, count data only model for a common species
...
save(outs, sp_info, alpha1_diff, N_RB_TC, file = paste0("simulation_comparison_ssc_common_", Sys.Date(), ".RData"))